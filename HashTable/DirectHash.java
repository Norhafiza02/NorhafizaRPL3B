/**
 * Kelas DirectHash
 * Implementasi sederhana hash table menggunakan array.
 * Nilai data (value) digunakan sebagai kunci (key) atau indeks langsung dalam array.
 */
public class DirectHash {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hasil pencarian nilai 100 di indeks: " + directHash.search(100));  // Harusnya mengembalikan 100

        // Mencari nilai yang tidak ada
        System.out.println("Hasil pencarian nilai 150 di indeks: " + directHash.search(150));  // Harusnya mengembalikan -1 (tidak ditemukan)
    }
}
