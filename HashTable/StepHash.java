/**
 * Kelas StepHash
 * Implementasi sederhana hash table menggunakan array dengan teknik "step hashing" untuk menangani kolisi.
 */
public class StepHash {
     ...
     * @param size Ukuran array hash table
     */
    ...
    public void insert(int value) {
        ...
        while (table[index] != 0) {
            System.out.println("Terjadi kolisi pada indeks: " + index);
        ...
        System.out.println("Data dimasukkan ke indeks: " + index);
    }
    ...
    public static void main(String[] args) {
        ...
        // Mencari nilai
        System.out.println("Hasil pencarian nilai 9 di indeks: " + stepHash.search(9));  // Harusnya mengembalikan 9
        System.out.println("Hasil pencarian nilai 50 di indeks: " + stepHash.search(50));  // Harusnya mengembalikan 50
        System.out.println("Hasil pencarian nilai 8 di indeks: " + stepHash.search(8));  // Harusnya mengembalikan 100

        // Mencari nilai yang tidak ada
        System.out.println("Hasil pencarian nilai 200 di indeks: " + stepHash.search(200));  // Harusnya mengembalikan -1 (tidak ditemukan)
    }
}
