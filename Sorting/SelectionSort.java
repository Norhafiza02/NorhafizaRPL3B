...
public class SelectionSort {
    ...
    public static int[] selectionSort(int[] array) {/**
       ...
       public class SelectionSort {
            ...
            */
           public static int[] selectionSort(int[] array) {
               int ukuran = array.length; // Ukuran array
       
               // Iterasi selama masih ada elemen yang belum diurutkan
               while (ukuran > 0) {
                   int max = 0; // Asumsi elemen pertama adalah yang terbesar
       
                   // Mencari elemen terbesar dalam subarray belum diurutkan
                   ...
                   // Menukar elemen terbesar dengan elemen di akhir subarray belum diurutkan
                   int temp = array[max];
                   array[max] = array[ukuran - 1];
                   array[ukuran - 1] = temp;
       
                   // Mengurangi ukuran subarray belum diurutkan karena elemen terbesar sudah di tempat yang tepat
                   ukuran--;
               }
